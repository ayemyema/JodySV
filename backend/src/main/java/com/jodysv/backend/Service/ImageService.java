...
public class ImageService {
    ...
    public String saveImage(MultipartFile file, String category) throws IOException {
        ...
        Path categoryDirectory =
                uploadDirectory.resolve(safeCategory).normalize();

        if (!categoryDirectory.startsWith(uploadDirectory)) {
        ...
        Path destination =
                categoryDirectory.resolve(newFilename).normalize();
    ...
    public List<String> getImages(String category) throws IOException {
    ...
    public void deleteImage(String category, String filename)
        ...
        Path imagePath =
                categoryDirectory.resolve(safeFilename).normalize();
    ...
    private String sanitizeCategory(String category) {
        ...
        return switch (cleaned) {
            ...
            default -> throw new IllegalArgumentException(
                    "Invalid category. Use wedding, birthday, christening, or other."
            );
        };
    }
}
